            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card bg-light text-dark shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5 text-center">
                        <h2 class="fw-bold mb-4 text-uppercase"><?php echo _("Register"); ?></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <label class="form-label" for="u_name"><?php echo _("Username"); ?></label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4 pb-2">
                                    <select class="form-control form-control-lg" name="language" id="language">
                                        ...
                                        <option value="ro"><?php echo _("French"); ?></option>
                                        <option value="hu"><?php echo _("Hungarian"); ?></option>
                                        <option value="fr"><?php echo _("Romanian"); ?></option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 pb-2">
                                    <div class="form-outline">
                                        ...
                                        <label class="form-label" for="password"><?php echo _("Password"); ?></label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4 pb-2">
                                    <div class="form-outline">
                                        ...
                                        <label class="form-label" for="password_c"><?php echo _("Confirm Password"); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-4 pt-2">
