                    ...
                    <div class="card bg-light text-dark" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                <h2 class="fw-bold mb-2 text-uppercase"><?php echo _("Password Reset"); ?></h2>
                                <p class="text-dark-50 mb-5"><?php echo _("Insert your current password and the new password"); ?></p>
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <label class="form-label" for="current_password"><?php echo _("Curent Password"); ?></label>
                                </div>
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <label class="form-label" for="new_password"><?php echo _("New Password"); ?></label>
                                </div>
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <label class="form-label" for="new_password_c"><?php echo _("Confirm New Password"); ?></label>
                                </div>
                                <button class="btn btn-dark btn-lg px-5" type="submit" name="reset_password"><?php echo _("Reset Password"); ?></button>
                            </div
                        </div>
                    </div>
                </div>
